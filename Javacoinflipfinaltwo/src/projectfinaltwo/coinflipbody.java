...
//java utility for input mismatch exceptions 
import java.util.Random;
//Java utility used to create a random number
	
	public class coinflipbody extends coinflipcode {
		//coinflipbody extends to the coinflipcode class where we are able to inherit all of the scanners and information from the coinflipcode class
	...
	public static void menudisplay() {
		...
		trycatch();
		//calls the menudisplay2() method
	}

		public static void trycatch() {
		
		    try {	//the try keyword first will run the code below and if there are no errors, it will continue to the playgamemenu() method
		    	...
		    	//catches if there is a input mismatch exception
		      System.out.println("Sorry you cant do that, please retry entering your age only using numbers");
		      //if the program has an error and it is caught it will display this println
		      menudisplay();
		      //returns to menudisplay where user can try again to enter age
		    }
